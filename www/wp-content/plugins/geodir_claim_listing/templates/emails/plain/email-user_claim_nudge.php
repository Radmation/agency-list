<?php
/**
 * Email To Listing Contact Email Address (Plain Text)
 *
 * This template can be overridden by copying it to yourtheme/geodirectory/emails/plain/email-user_claim_nudge.php.
 *
